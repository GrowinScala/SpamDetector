...
*/
  ...
  val finalCategorization = decisionTree(categorizePositionsE,listOfCVintersected,List("WEBSITE","PHONENUMBER","PER"),specificKeywords)
//listOfCVintersected
// == 0 && trainingSetStopWords.drop(x).head._2.contains("WEBSITE"))
  evaluationMetrics(cvCategoriesVector, finalCategorization)
